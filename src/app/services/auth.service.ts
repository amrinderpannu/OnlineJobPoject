...
export class AuthService {
  ...
  login(username: string, password: string): any {
    return this.http.post<[]>('http://onlinejobportalbyhustlers-env.eba-t4m5bnuh.us-west-2.elasticbeanstalk.com/authenticate', {
      username,
      password
    }, { observe: 'response' })
      .pipe(
  ...
  register(data: any): Observable<any> {
    console.log(data);
    return this.http.post("http://onlinejobportalbyhustlers-env.eba-t4m5bnuh.us-west-2.elasticbeanstalk.com/sign-up", data);
  }
